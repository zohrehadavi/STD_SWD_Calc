...
#    File Converted to python script by Zohreh Adavi zohreh.adavi@tuwien.ac.at, February 2023
# =============================================================================  
...
def gpt3_5_fast(mjd = None,lat = None,lon = None,h_ell = None,it = None): 
    
    grid=gpt3_5_fast_readGrid(filename ='gpt3_5.grd')
